...
class Trainer(object):
    ...
    def test_one_dataset(self, data_loader):
        ...
        for i, data_dict in tqdm(enumerate(data_loader),total=len(data_loader)):
            ...
            fflabel_lists += list(data_dict['fflabel'].cpu().detach().numpy())
        ...
        return test_recorder_loss, np.array(prediction_lists), np.array(label_lists),np.array(feature_lists),np.array(fflabel_lists)
    ...
    def test_epoch(self, epoch, iteration, test_data_loaders, step):
        ...
        for key in keys:
            ...
            losses_one_dataset_recorder, predictions_nps, label_nps, feature_nps, fflabel_nps = self.test_one_dataset(test_data_loaders[key])
